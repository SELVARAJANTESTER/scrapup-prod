...
const payload = JSON.stringify({ customerName: 'Image Test 3001', phone: '+1000000000', address: 'Test Addr 3001', lat: 1.23, lng: 4.56, scrapTypes: [{type:'Metal Scrap', quantity:2}], preferredDate: '2025-08-30', preferredTime: 'morning', instructions: 'With image', images: [{ name: 'test.png', data: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGNgYAAAAAMAASsJTYQAAAAASUVORK5CYII=' }] });
const opts = { hostname: 'localhost', port: 3001, path: '/api/requests', method: 'POST', headers: { 'Content-Type': 'application/json', 'Content-Length': Buffer.byteLength(payload) } };
